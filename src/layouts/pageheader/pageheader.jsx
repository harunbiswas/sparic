    ...
    <Fragment>
      <div className="page-header d-sm-flex d-block">
        ...
        <div className=" ms-auto mt-2 mt-sm-0">
          <Link
            to="/"
            className="btn bg-secondary-transparent text-secondary btn-sm"
          >
            {" "}
            <OverlayTrigger
              placement="bottom"
          ...
          <Link
            to={`${import.meta.env.BASE_URL}authentication/lockscreen`}
            className="btn bg-primary-transparent text-primary mx-2 btn-sm"
          >
            {" "}
            <OverlayTrigger
              placement="bottom"
          ...
          <Link
            to="#"
            className="btn bg-warning-transparent text-warning btn-sm"
          >
            {" "}
            <OverlayTrigger
              placement="bottom"
