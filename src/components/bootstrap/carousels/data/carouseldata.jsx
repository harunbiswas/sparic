...
export const Crossfade = [{ src1: photo4 }, { src1: photo5 }, { src1: photo7 }];
export const Caption = [
  {
    title: "Carousel with GradientBackground  caption",
    src1: photo46,
    src2: photo47,
    src3: photo48,
    h1: " Slide label",
    h2: "Slide label",
    h3: "Slide label",
    text: "The wise man therefore always holds in these matters to this principle of selection he rejects pleasures.",
    color: "text-white",
  },
  {
    title: "Carousel with Background color captions",
    src1: photo55,
    src2: photo39,
    src3: photo49,
    h1: "First slide label",
    h2: "Second slide label",
