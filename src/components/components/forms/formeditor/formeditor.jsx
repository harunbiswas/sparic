              ...
              <div className="ql-wrapper ql-wrapper-demo">
                ...
                <div id="quillEditor">
                  <p>
                    ...
                    and expressive API, it is completely customizable to fit any
                    need.
                  </p>
                  <br />
                  <p>
                    The icons use here as a replacement to default svg icons are
                    from{" "}
                ...
                >
                  <Modal.Header className="pd-20">
                    ...
                    <Link
                      as="span"
                      href="#"
                      className="text-dark d-flex ms-auto my-auto"
                      onClick={() => {
                        handleClose("Basic");
                      }}
                    >
